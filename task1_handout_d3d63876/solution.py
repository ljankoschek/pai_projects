...
class Model(object):
    ...
    def __init__(self):
        ...
        self.global_kernel = Matern(length_scale=21, nu=1.5, length_scale_bounds="fixed") # kernel for residential areas
    ...
    def train_model(self, train_targets: np.ndarray, train_coordinates: np.ndarray, train_area_flags: np.ndarray):
        ...
        for cluster_idx in range(self.num_clusters):
            ...
            kernel = Matern(length_scale=20, nu=1.5, length_scale_bounds="fixed")
